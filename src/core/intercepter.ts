...
const matchWebsite = (host: string, websites: Record<string, WebSiteDataModel>) => {
...
type MatchedResult = { path: string | undefined, data: PageModelItem | undefined } | undefined
export const getMatchedSync = (
  urlObj: URL, websites: Record<string, WebSiteDataModel> = {}
): MatchedResult => {
